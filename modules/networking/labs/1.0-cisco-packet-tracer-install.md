# Lab 1.0 - Cisco Packet Tracer Installation and Discovery

**Objective:** Install Cisco Packet Tracer and discover its key components

## Part 1: Download and Install Cisco Packet Tracer
...
1. Download Cisco Packet Tracer 9.0:
   - Navigate to: [https://we.tl/t-6kbJscKw74](https://we.tl/t-6kbJscKw74)
   - Click the **Download** button
   - Save `CiscoPacketTracer_900_win_64bit.exe` to your Downloads folder
   - The file is approximately 287 MB and may take a few minutes to download
...
1. Locate the downloaded installer:
   ...
   - Find `CiscoPacketTracer_900_win_64bit.exe`

2. Run the installer:
   - Right-click on `CiscoPacketTracer_900_win_64bit.exe`
...
3. Follow the installation wizard:
   ...
   - Choose the installation directory (default: `C:\Program Files\Cisco Packet Tracer 9.0`) or customize as needed
...
5. Launch Cisco Packet Tracer:
   - Double-click the **Cisco Packet Tracer** icon on your desktop
   - Or find it in the Start Menu: **Start** → **Cisco Packet Tracer**
   - On first launch, you may be prompted to log in with Cisco Networking Academy credentials (optional - you can skip this for lab purposes)

### Troubleshooting

- **Installation fails**: Ensure you have administrator privileges and sufficient disk space
- **Application won't launch**: Try restarting your computer after installation
- **Missing Visual C++ Runtime**: If prompted, download and install Microsoft Visual C++ Redistributable from the Microsoft website

## Part 2: Cisco Packet Tracer Discovery
