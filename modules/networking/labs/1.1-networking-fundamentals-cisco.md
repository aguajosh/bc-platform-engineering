...
> Note: The subnet mask `255.255.255.0` is automatically filled when you type `/24` in Packet Tracer.
...
## Step 4. Observe OSI Encapsulation
...
## Step 5. Build and Configure the ARP Network

3. Configure IP addresses as above.

---

## Step 6. Observe the ARP Process
...
## Step 7. Subnet and Plan the Network
...
## Step 8. Configure Router Interfaces
...
## Step 9. Verify Connectivity Between Routers
...
> Note: If pings fail, ensure subnets match, interfaces are up, and cables are correct.

---

## Step 10. Configure Static Routes (Optional)
...
> Note: This step helps understand **Layer 3 routing** and inter-router communication.
